...
int main(int argc, char **argv) {
  ...
  printf("copyi1 : %f GB/s, time : %f \n",
         tot_size * 2 * sizeof(float) /
             (timings[copyi1_st] / (double)(tsteps - (warmup_step + 1))) /
             (1024. * 1024. * 1024.),
         timings[copyi1_st]);
  printf("sumi1 : %f GB/s, time : %f \n",
         tot_size * 2 * sizeof(float) /
             (timings[sumi1_st] / (double)(tsteps - (warmup_step + 1))) /
             (1024. * 1024. * 1024.),
         timings[sumi1_st]);
  printf("sumj1 : %f GB/s, time : %f \n",
         tot_size * 2 * sizeof(float) /
             (timings[sumj1_st] / (double)(tsteps - (warmup_step + 1))) /
             (1024. * 1024. * 1024.),
         timings[sumj1_st]);
  printf("sumk1 : %f GB/s, time : %f \n",
         tot_size * 2 * sizeof(float) /
             (timings[sumk1_st] / (double)(tsteps - (warmup_step + 1))) /
             (1024. * 1024. * 1024.),
         timings[sumk1_st]);
  printf("avgi : %f GB/s, time : %f \n",
         tot_size * 2 * sizeof(float) /
             (timings[avgi_st] / (double)(tsteps - (warmup_step + 1))) /
             (1024. * 1024. * 1024.),
         timings[avgi_st]);
  printf("avgj : %f GB/s, time : %f \n",
         tot_size * 2 * sizeof(float) /
             (timings[avgj_st] / (double)(tsteps - (warmup_step + 1))) /
             (1024. * 1024. * 1024.),
         timings[avgj_st]);
  printf("avgk : %f GB/s, time : %f \n",
         tot_size * 2 * sizeof(float) /
             (timings[avgk_st] / (double)(tsteps - (warmup_step + 1))) /
             (1024. * 1024. * 1024.),
         timings[avgk_st]);
  printf("lap : %f GB/s, time : %f \n",
         tot_size * 2 * sizeof(float) /
             (timings[lap_st] / (double)(tsteps - (warmup_step + 1))) /
             (1024. * 1024. * 1024.),
         timings[lap_st]);

  {
    ...
    stencils.push_back(JSONNode(
        ...
        tot_size * 2 * sizeof(float) /
            ...
            (1024. * 1024. * 1024.)));
    stencils.push_back(JSONNode(
        "avgi", tot_size * 2 * sizeof(float) /
                    (timings[avgi_st] / (double)(tsteps - (warmup_step + 1))) /
                    (1024. * 1024. * 1024.)));
    stencils.push_back(JSONNode(
        "avgj", tot_size * 2 * sizeof(float) /
                    (timings[avgj_st] / (double)(tsteps - (warmup_step + 1))) /
                    (1024. * 1024. * 1024.)));
    stencils.push_back(JSONNode(
        "avgk", tot_size * 2 * sizeof(float) /
                    (timings[avgk_st] / (double)(tsteps - (warmup_step + 1))) /
                    (1024. * 1024. * 1024.)));
    stencils.push_back(JSONNode(
        "lap", tot_size * 2 * sizeof(float) /
                   (timings[lap_st] / (double)(tsteps - (warmup_step + 1))) /
                   (1024. * 1024. * 1024.)));
...

  {
    ...
    stencils.push_back(JSONNode(
        ...
        tot_size * 2 * sizeof(double) /
            ...
            (1024. * 1024. * 1024.)));
    stencils.push_back(JSONNode(
        "avgi", tot_size * 2 * sizeof(double) /
                    (timings[avgi_st] / (double)(tsteps - (warmup_step + 1))) /
                    (1024. * 1024. * 1024.)));
    stencils.push_back(JSONNode(
        "avgj", tot_size * 2 * sizeof(double) /
                    (timings[avgj_st] / (double)(tsteps - (warmup_step + 1))) /
                    (1024. * 1024. * 1024.)));
    stencils.push_back(JSONNode(
        "avgk", tot_size * 2 * sizeof(double) /
                    (timings[avgk_st] / (double)(tsteps - (warmup_step + 1))) /
                    (1024. * 1024. * 1024.)));
    stencils.push_back(JSONNode(
        "lap", tot_size * 2 * sizeof(double) /
                   (timings[lap_st] / (double)(tsteps - (warmup_step + 1))) /
                   (1024. * 1024. * 1024.)));
